...
Donate link: http://smooththemes.com/
...
WP Users is simple to create front-end login, register profile forms for your site.
...
1. Upload `wp-users` to the `/wp-content/plugins/` directory
