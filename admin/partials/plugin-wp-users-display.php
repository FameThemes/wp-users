...
if ( isset( $_POST['submit'] ) ) {
    $option_keys = array(
        'wp_users_account_page'          => '',
        'wp_users_disable_default_login' => '',
    ...
    foreach ( $option_keys as $k => $v ) {
        // if the key container "wp_users_"  at begin of string the save it
        if ( isset( $_POST[ $k ] ) ) {
...
<form novalidate="novalidate" action="" method="post">
    ...
    <table class="form-table">
        ...
        <tr>
            ...
            <td>
                ...
                wp_dropdown_pages (
                    ...
                    //'depth'                 => 0,
                    //'child_of'              => 0,
                    'selected'              => get_option( 'wp_users_account_page' ),
                    //'echo'                  => 1,
                    'name'                  => 'wp_users_account_page',
                    'id'                    => null, // string
        ...
        <tr>
            ...
            <td>
                <fieldset>
                    ...
                    <label >
                        <input type="checkbox" <?php checked ( get_option( 'wp_users_disable_default_login' ) , 1 ) ?> value="1"  name="wp_users_disable_default_login">
        ...
        <tr>
            ...
            <td>
                <input type="text" class="regular-text" value="<?php echo esc_attr( get_option( 'wp_users_login_redirect_url' ) ); ?>" id="wp_users_login_redirect_url" name="wp_users_login_redirect_url">
                <p class="description"><?php _e( 'The url will redirect when you logged in, leave empty to redirect home page.', 'wp-users' ); ?></p>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" class="regular-text" value="<?php echo esc_attr( get_option( 'wp_users_logout_redirect_url' ) ); ?>" id="wp_users_logout_redirect_url" name="wp_users_logout_redirect_url">
                <p class="description"><?php _e( 'The url will redirect when you logout, leave empty to redirect home page.', 'wp-users' ); ?></p>
            </td>
        </tr>


        <tr>
            <th scope="row"><label for="wp_users_term_page"><?php _e('Term and Condition','wp-users'); ?></label></th>
            <td>
                <?php
                wp_dropdown_pages(
                    array(
                        //'depth'                 => 0,
                        //'child_of'              => 0,
                        'selected'              => get_option('wp_users_term_page'),
                        //'echo'                  => 1,
                        'name'                  => 'wp_users_term_page',
                        'id'                    => null, // string
                        'show_option_none'      => __('Select a page','wp-users'), // string
                        'show_option_no_change' => null, // string
                        'option_none_value'     => null, // string
